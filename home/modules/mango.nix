...

{
  wayland.windowManager.mango = {
    ...
    extraConfig = ''
      ...
      # exit
      bind=SUPER,m,quit
      bind=SUPER+SHIFT,e,spawn,wlogout
      ...
      # Screenshot
      bind=NONE,Print,spawn,grim ~/Pictures/Screenshot-$(date +%Y%m%d-%H%M%S).png
      bind=SHIFT,Print,spawn,grim -g "$(slurp)" ~/Pictures/Screenshot-$(date +%Y%m%d-%H%M%S).png
    '';
    autostart_sh = ''
